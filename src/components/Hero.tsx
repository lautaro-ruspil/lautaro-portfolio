      ...
      <div className="relative z-10 max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center md:text-left">
          ...
          >
            Soy Lautaro Ruspil.
            <br />
            <span className="text-emerald-400">Construyo productos web</span>
            <br />
            de principio a fin.
          </motion.h1>
          ...
          >
            Desarrollador full stack con foco en frontend.
            Diseño, codifico y deployeo apps con React, TypeScript
            y NestJS — cada proyecto que ves acá está en producción.
          </motion.p>

          {/* Proof line */}
          <p className="text-xs text-neutral-500 mb-8">
            5 apps en producción · Auth, APIs REST, dashboards · Disponible para trabajo remoto
          </p>
